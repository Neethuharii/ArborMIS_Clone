...
final class Version20260611065104 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE IF NOT EXISTS genders (gender_id INT AUTO_INCREMENT NOT NULL, gender_type VARCHAR(150) NOT NULL,  PRIMARY KEY (gender_id)) DEFAULT CHARACTER SET utf8mb4');
    }
