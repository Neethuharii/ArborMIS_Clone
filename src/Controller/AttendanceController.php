...
final class AttendanceController extends AbstractController
{
    ...
    public function index(
        ...
        return $this->render(
            'Attendances/DailyAttendances.html.twig',
            [
                'attendanceDates' => $attendanceService->getAttendanceDates(),
                'currentSession' => $attendanceService->getCurrentAttendanceSession(),
                'students' => $attendanceService->getStaffStudents($staff),
...
#[Route('/registers', name: 'app_attendance_registers')]
public function registers(): Response
{
    return $this->render('Attendances/AttendanceRegisters.html.twig');
}
